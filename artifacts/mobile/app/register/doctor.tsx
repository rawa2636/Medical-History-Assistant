    ...
    return (
      <View style={[styles.container, { backgroundColor: C.background }]}>
        <View style={[styles.successScreen, { paddingTop: topPad }]}>
          ...
          <View style={[styles.successBanner, { backgroundColor: C.primary + "12", borderColor: C.primary + "30" }]}>
            <Feather name="clock" size={16} color={C.primary} />
            <Text style={[styles.successBannerText, { color: C.primary }]}>
              سيتم مراجعة بياناتك من قِبل الإدارة وتفعيل حسابك خلال 24-48 ساعة. بإمكانك تسجيل الدخول بعد الموافقة.
            </Text>
          </View>
          <TouchableOpacity
